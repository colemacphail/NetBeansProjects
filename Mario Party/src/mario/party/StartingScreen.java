...
public class StartingScreen extends javax.swing.JFrame {
    ...
    private Map selectedMap = Map.BASIC;
    ...
    public StartingScreen() {
        ...
        this.jTextField1.setText(String.valueOf(this.numOfPlayers));
    }
    ...
    private void initComponents() {
        ...
        maps.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Basic" }));
    ...
    private void mapsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mapsActionPerformed
        ...
        String mapString = (String) maps.getSelectedItem();
        selectedMap = Map.valueOf(mapString.toUpperCase());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        dispose();
        Game g = new Game(this.numOfPlayers, this.selectedMap);
        g.run();
    ...
    private void jSlider1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jSlider1StateChanged
        this.numOfPlayers = (int) this.jSlider1.getValue();
        this.jTextField1.setText(String.valueOf(this.numOfPlayers));
    ...
    private javax.swing.JComboBox<String> maps;
